...
{
    public partial class frm_Vehicle_Report : Form
    {
        ReportDocument rd = new ReportDocument();

        public frm_Vehicle_Report()
        {
            InitializeComponent();
        }
        ...
        private void frm_Vehicle_Report_Load(object sender, EventArgs e)
        {
            string sqlStr = "Select * from Vehicle_Details";
            ...
            Vehicle_CrystalReport cr = new Vehicle_CrystalReport();
            cr.SetDataSource(ds);
